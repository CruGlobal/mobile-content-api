...
unless Attachment.exists?(resource: kgp)
  ...
  Attachment.create!(resource: kgp, file: Rack::Test::UploadedFile.new("spec/fixtures/web_attach.png", "image/png"))
  Attachment.create!(resource: kgp, file: Rack::Test::UploadedFile.new("spec/fixtures/web_bundled.png", "image/png"))
end
...
Destination.find_or_create_by!(service_type: :salesforce, url: "https://salesforce.com/", service_name: "GodTools New Growth Series", access_key_id: "67891", access_key_secret: "this is another secret")

...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "mobile-content-api_production"
  ...
  config.middleware.insert_before 0, Rack::Cors do
    allow do
      ...
      resource "*", headers: :any, methods: [:get, :post, :put, :patch, :options, :delete], credentials: true, expose: ["Authorization"]
    end
